...
fun <T> Observable<T>.wrap(code: EnumErrorCode): Observable<T> = onErrorResumeNext { th: Throwable -> Observable.error(Error.wrap(th, code)) }
...
fun <T> Flowable<T>.wrap(code: EnumErrorCode): Flowable<T> = onErrorResumeNext { th: Throwable -> Flowable.error(Error.wrap(th, code)) }
...
fun <T> Single<T>.wrap(code: EnumErrorCode): Single<T> = onErrorResumeNext { th: Throwable -> Single.error(Error.wrap(th, code)) }
...
fun <T> Maybe<T>.wrap(code: EnumErrorCode): Maybe<T> = onErrorResumeNext { th: Throwable -> Maybe.error(Error.wrap(th, code)) }
...
fun Completable.wrap(code: EnumErrorCode): Completable = onErrorResumeNext { Completable.error(Error.wrap(it, code)) }
